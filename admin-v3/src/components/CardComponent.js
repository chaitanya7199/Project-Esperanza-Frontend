...
class CardComponent extends Component {
    ...
    componentDidMount = () => {
        ...
        if (res.statusCode === 200) {
            ...
            this.setState({
                editProduct: JSON.parse(res.getBody())
            })
        }
        /* this.setState({
            editProduct: {
        ...
        return (
            <div className="container">
                <form onSubmit={(e) => {
                    ...
                    <div className="form-row">
                        <div className="form-group col-12">
                            <label className="float-left font-weight-bold" style={{ color: "#ae275f" }}>Banner Image Source:</label><br />
                            <input type="text" name="bannerSrc" value={this.state.editProduct.bannerSrc} onChange={this.setEditProductValues} className="form-control" placeholder="Ex :https://example.com/image.jpeg" required />
                        </div>
                    </div><hr />
                    <div className="form-row">
                        <div className="form-group col-12">
