...
class FormFieldCardComponent extends Component {
                    ...
                    <div className="row">
                        ...
                        <div className="col-6">
                            <button className="btn btn-danger" style={{width : "100%"}} onClick={(e)=>{
                                ...
                                {
                                    this.props.deleteFormField(this.props.config.name)
                                }
                        ...
                        Object.keys(this.props.config).map((keyName, keyIndex) => {
                            return (
                                <tr>
                                    ...
                                    {
                                    (keyName !== "validation") ?
                                    <input type="text" className="form-control" name={keyName} value={this.state.formData[keyName]} onChange={this.setValues}/>
                                    :
                                    <td>
                                        {
                                            Object.keys(this.props.config[keyName]).map((kname) => {
                                                return (
                                                    <>
                                                        <span style={{ color: "#b11254" }}>{kname}</span> : 
                                                        <input type="text" className="form-control" name={kname} onChange={this.setValidationValues} value={this.state.formData[keyName][kname]}/>
                                                        <br />
                                                    </>
                                                )
                                            })
                    ...
                    <div className="row">
                        <div className="col-6">
                            <button className="btn btn-primary" style={{width : "100%"}} onClick={(e)=>{
                                ...
                                {
                                  this.props.editFormField(this.props.config.name , this.state.formData)
                                }
                            }}>Submit</button>
                        </div>
                        <div className="col-6">
...
export default FormFieldCardComponent;