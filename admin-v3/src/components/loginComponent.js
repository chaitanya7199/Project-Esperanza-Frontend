                    ...
                    <button onClick={()=>{this.logout()}}>Logout</button> */}
                        ...
                        <BrowserRouter>
                            <Switch>
                                ...
                                <Route exact path="/form" component={FormFieldComponent} />
                                <Route exact path="/partners" component={PartnerComponent} />
                                <Route exact path="/api-config" component={ApiConfigComponent} />
                            </Switch>
                        </BrowserRouter>
                    </div>
