                ...
                <form onSubmit={(e) => {
                    ...
                    <div className="form-row">
                        <div className="form-group col-12">
                            ...
                            <input type="text" name="bannerSrc" value={this.state.addProduct.bannerSrc} onChange={this.setAddProductValues} className="form-control" placeholder="Ex :https://example.com/image.jpeg" required />
                        </div>
                    </div><hr />
                    <div className="form-row">
                        <div className="form-group col-12">
